...
export default function ProductCard({title,price,rating,category,brand,desc}) {
    // console.log({...e})
    // const {title,description,price,category,thumbnail,rating,brand} = e
  const [show1,setShow1] = React.useState(false)
  const [show2,setShow2] = React.useState(false)
  let total = React.useContext(CartContext)
  return (
